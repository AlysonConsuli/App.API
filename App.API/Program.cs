...
var connectionString = builder.Configuration.GetConnectionString("StarWarsDbConnectionString");
...
builder.Services.AddIdentityCore<ApiUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<ApiUser>>("StarWarsApi")
